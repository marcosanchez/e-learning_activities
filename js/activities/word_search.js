...
/*--Activity 1 page 10--*/
    var words = "earth,mars,mercury,neptune,pluto,saturn,jupiter,one,two,three,four,five,six,seven,eight,mozart,bach,meyer,rose,mahler";
    $("#word_search_1_page_10").wordsearchwidget({"wordlist" : words,"gridsize" : 15});
